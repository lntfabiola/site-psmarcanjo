...
O projeto está configurado como **Progressive Web App (PWA)**, permitindo que os fiéis o instalem diretamente em seus celulares (Android e iOS) ou computadores, funcionando como um aplicativo nativo com suporte a ícones dedicados.
